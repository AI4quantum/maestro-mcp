...
# Maestro MCP Server Stop Script
...
print_help() {
    echo -e "${BLUE}Maestro MCP Server Stop Script${NC}"
    echo ""
...
stop_server() {
    print_header "Stopping Maestro MCP Server..."
...
restart_server() {
    print_header "Restarting Maestro MCP Server..."
